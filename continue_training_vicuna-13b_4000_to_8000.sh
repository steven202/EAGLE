#!/bin/bash
#SBATCH --job-name=continue_vicuna13b_4000_8000
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --array=1
#SBATCH --gres=gpu:1
#SBATCH --output=outputs/continue_vicuna13b_4000_8000_%A_%a.log
...
# CONTINUED TRAINING SCRIPT: Vicuna-13B from 4000 to 8000 questions
...
DATE="${DATE}_continued_vicuna13b_4000_8000"

# MODEL CONFIGURATION - Vicuna-13B
MODEL_NAME="Vicuna-13B"
MODEL_PATH="yuhuili/EAGLE3-Vicuna-13B"  # Update this path
BASE_MODEL_PATH="lmsys/vicuna-13b-v1.5"  # Update this path
GEN_SCRIPT="gen_ea_answer_vicuna_rl"  # Vicuna-specific script
BASELINE_SCRIPT="gen_baseline_answer_vicuna"  # Vicuna-specific script
EAGLE3_SCRIPT="gen_ea_answer_vicuna"  # Vicuna-specific script
...
SOURCE_DATE="20250730_160223_ofl128_vicuna13b"
SOURCE_BASE_DIR="log/results_vicuna-13b/$SOURCE_DATE"
...
echo ""
echo "=== Phase 3: Evaluation of Continued Policy (Vicuna-13B) ==="
...
echo ""
echo "=== Phase 4: Performance Analysis (Vicuna-13B) ==="
